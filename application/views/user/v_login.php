                ...
                <?=form_open('login/logindo')?>
                    <fieldset>
                        ...
                        <div class="clearfix">
                            ...
                            <button type="submit" class="width-35 pull-right btn btn-sm btn-danger" name="login">
                        ...
                        <br>
							...
							<?php if($this->session->userdata('d_message')) : ?>
								<div class='alert alert-danger'><?=$this->session->userdata('d_message')?></div>
							<?php endif; ?>
